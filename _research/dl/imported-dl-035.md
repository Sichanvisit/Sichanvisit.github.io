...
| Track | DL |
| Type | Shared Note |
| Source Title | `Faster R-CNN` |
| Source Path | `12_Deep_Learning/Code_Snippets/6-1_Faster R-CNN - 공유.md` |

## Source Glimpse

> Faster R-CNN(coco_pytorch) / - Faster RCNN : https://pytorch.org/vision/0.9/_modules/torchvision/models/detection/faster_rcnn.html#fasterrcnn_resnet50_fpn
