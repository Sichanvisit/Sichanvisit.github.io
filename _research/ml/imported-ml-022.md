...
<div class="research-doc-hero">
  <div class="research-doc-summary">
    ...
    <p class="research-doc-summary__body">결정 트리와 앙상블 기법을 사용하여 분류 모델을 구축. 마케팅 캠페인의 효율성을 높이는 전략을 도출</p>
  </div>
...
<div class="research-doc-card">
  ...
  <p class="research-doc-card__value">CSV 데이터 불러오기 · LabelEncoder 전처리 · 데이터 시각화 후 추가 파생변수 생성</p>
</div>
  </div>
...
<div class="research-doc-stat">
  <span>주요 스택</span>
  <strong>urllib, helper_c0z0c_dev, time, pandas 외 1</strong>
</div>
  </div>
</div>
