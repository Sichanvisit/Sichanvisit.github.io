...
<div class="research-compact-wrap">
  <table class="research-compact-table research-compact-table--steps">
    ...
    <tr>
      ...
      <td>
        <strong class="research-compact-table__main">DecisionTree / AdaBoost 모델 구성</strong>
        <span class="research-compact-table__sub">DecisionTree / AdaBoost 같은 모델을 올려 두고 어떤 알고리즘이 문제에 더 잘 맞는지 비교해 보는 구간입니다.</span>
      </td>
      <td><code>DecisionTree</code> <code>AdaBoost</code></td>
      <td><span class="research-compact-table__muted">-</span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <strong class="research-compact-table__main">from sklearn.ensemble import AdaBoostClassifier</strong>
        <span class="research-compact-table__sub">전처리와 학습/검증 분리를 담당해 전체 파이프라인의 출발점을 정리하는 코드입니다.</span>
      </td>
      <td><code>train_test_split</code> <code>DecisionTree</code> <code>AdaBoost</code> <code>accuracy_score</code></td>
      <td><span class="research-compact-table__muted">-</span></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>
        <strong class="research-compact-table__main">X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.3, rand...</strong>
        <span class="research-compact-table__sub">전처리와 학습/검증 분리를 담당해 전체 파이프라인의 출발점을 정리하는 코드입니다.</span>
      </td>
