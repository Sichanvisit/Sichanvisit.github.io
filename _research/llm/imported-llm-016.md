...
excerpt: "https://huggingface.co/docs/transformers/en/model_doc/gpt2. 페이지 상단에서 문제 정의, 구현 범위, 코드 하이라이트를 먼저 확인하고 바로 원본 실습 맥락으로 내려갈 수 있게 구성했습니다. `md` 원본과 26개 코드 블록, 23개 실행 셀을 함께 남겨..."
