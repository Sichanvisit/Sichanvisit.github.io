...
excerpt: "LangChain의 핵심 컴포넌트 이해 및 활용 2. RAG(Retrieval Augmented Generation) 시스템 구축 3. LangSmith를 통한 모니터링 및 디버깅: 로그인후에 API 키 생성 - https://smith.langchain.com/ 4. 실전 FAQ 챗봇 개발. IT..."
...
### LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > 학습 목표
...
### LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > 시나리오

IT 회사 FAQ 챗봇: 직원들의 자주 묻는 질문에 자동으로 답변하는 시스템

### LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > Step 2: FAQ 데이터 준비

실제 회사에서 사용할 법한 HR FAQ 데이터를 준비합니다.

### LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > Step 3: 기본 LangChain 챗봇 (RAG 없이)
...
1. LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > 학습 목표: LangChain의 핵심 컴포넌트 이해 및 활용 2. RAG(Retrieval Augmented Generation) 시스템 구축 3. LangSmith를 통한 모니터링 및 디버깅: 로그인후에 API 키 생성...
2. LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > 시나리오: IT 회사 FAQ 챗봇: 직원들의 자주 묻는 질문에 자동으로 답변하는 시스템
3. LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > Step 2: FAQ 데이터 준비: 실제 회사에서 사용할 법한 HR FAQ 데이터를 준비합니다.
4. LangChain & LangSmith 실습: 한국어 FAQ 챗봇 만들기 > Step 3: 기본 LangChain 챗봇 (RAG 없이): 먼저 간단한 LLM 기반 챗봇을 만들어봅니다.
